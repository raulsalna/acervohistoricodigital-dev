          ...
          <el-row :gutter="20" >
            <el-col :span="12">
              <el-form-item label="Sala de depósito">
                <el-input clearable size="small" v-model="searchBox.depositRoom"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="Corredor">
                <el-input clearable size="small" v-model="searchBox.corridor"></el-input>
              </el-form-item>
...
export default {
  ...
  methods: {
    AdvanceSearchClose() {
      ...
      this.searchBox.depositRoom='';
      this.searchBox.corridor='';
  ...
  watch: {
    ...
    "searchBox.depositRoom": function(value) {
      this.searchBox.depositRoom = value.replace(/[#$%&?|+=*!<>"';()/{}[\]\\]/g, "");
    },
    "searchBox.corridor": function(value) {
      this.searchBox.corridor = value.replace(/[#$%&?|+=*!<>"';()/{}[\]\\]/g, "");
    },
  }
};
</script>
